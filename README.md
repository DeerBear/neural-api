...
This project is [Lazarus](https://www.lazarus-ide.org/) based. That said, as of release [v2.0.0](https://github.com/joaopauloschuler/neural-api/releases/tag/v2.0.0), a number of units do compile with Delphi and you can create and run neural networks with Delphi. You'll be able to compile these units with Delphi: neuralvolume, neuralnetwork, neuralab, neuralabfun, neuralbit, neuralbyteprediction, neuralcache, neuraldatasets, neuralgeneric, neuralplanbuilder, Neural OpenCL, Neural Threading, neuralfit, neuralkantypes, neuralkanbasis, neuralkannormaliser and neuralkanattention. A standalone Delphi port of the library lives in [**delphi/neural**](https://github.com/joaopauloschuler/neural-api/tree/master/delphi/neural), and Delphi versions of the console examples are in [**delphi/examples**](https://github.com/joaopauloschuler/neural-api/tree/master/delphi/examples) &mdash; see its [README](https://github.com/joaopauloschuler/neural-api/tree/master/delphi/examples/README.md) for details.
