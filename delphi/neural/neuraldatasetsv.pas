...
// Hand-converted from ../../neural/neuraldatasetsv.pas via ../_port_tool.py, which
...
begin
  ...
  begin
    for J := 0 to 31 do
    begin
      Image.Canvas.Pixels[J, I] := RGB(TI.R[I, J], TI.G[I, J], TI.B[I, J]);
    end;
  end;
end;
  ...
  begin
    ...
    begin
      Image.Canvas.Pixels[J, I] :=
        RGB(TI.Grey[I, J], TI.Grey[I, J], TI.Grey[I, J]);
    end;
  end;
end;
