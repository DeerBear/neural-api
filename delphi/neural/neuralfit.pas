...
// Hand-converted from ../../neural/neuralfit.pas via ../_port_tool.py, which
...
{$DEFINE HASTHREADS}  // was: {$include neuralnetwork.inc} (FPC-mode/AVX pull dropped)
